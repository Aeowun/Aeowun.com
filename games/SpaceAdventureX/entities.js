...
function createEnemyBullet(enemy,playerY,difficulty){return{x:enemy.x,y:enemy.y,vx:-260-difficulty*220,vy:(playerY-enemy.y)*.12,r:5}}
window.SpaceAdventureEntities={createEnemy,createAsteroid,createPlayer,createPlayerBullet,createEnemyBullet};
})();
